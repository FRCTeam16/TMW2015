...
public:
	...
	static DigitalInput* driveBaseToteCenter;
	...
	static DigitalOutput* arduinoRobotState2;
	static DigitalOutput* arduinoSensorMiddleLeft;
	static DigitalOutput* arduinoSensorMiddle;
	static DigitalOutput* arduinoSensorMiddleRight;
