...
DriveBase::DriveBase() : Subsystem("DriveBase") {
	...
	totePresent = RobotMap::driveBaseTotePresent;
	autoToteSensor = RobotMap::driveBaseAutoToteSensor;
	...
	DriveControlUS->SetOutputRange(-.2, .2);
}
...
void DriveBase::Steer(float radian, float speed, float a) {
	...
	cout << "Radian:" << radian << "|| Speed:" << speed << endl;
