...
//	HomeLiftTask *homeLift;
	...
	typedef enum {TurnIntoFirstTote, MoveDartToVertical, WaitForDart, IndexUp, WaitForLift, SquareInSpace, DriveForwardToTote, DriveLeftToAutoZone, DropTotes, BackAwayFromTotes, CenterTote, End}AutoStep;
