...
//	HomeLiftTask *homeLift;
	typedef enum {ThreeTotePickup, Test3TotePickup, ContainerGrabber}AutoProgram;
	typedef enum {DriveAwayFromBumpWithCont, DriveOverBump, ExtendGrabber, RetractGrabber, DriveForwardToFirstTote, CrabToFirstTote, DriveOffBump, DriveAwayFromBump, FirstMove, DriveForward15, MoveDartToVertical, WaitForDart, IndexUp, WaitForLift, TurnTo40, SquareToWall, DriveForwardToTote, DriveToBump, DropTotes, BackAwayFromTotes, CenterTote, End}AutoStep;
