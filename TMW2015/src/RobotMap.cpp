...
SpeedController* RobotMap::stackerSqueeze = NULL;
CANTalon* RobotMap::grabberExtension = NULL;
...
void RobotMap::init() {
	...
	stackerLiftFrontLeft = new CANTalon(13);


	stackerDart = new CANTalon(15);
	
	
	stackerHome = new DigitalInput(0);
	lw->AddSensor("Stacker", "Home", stackerHome);
	
	stackerSqueeze = new Talon(4);
	lw->AddActuator("Stacker", "Squeeze", (Talon*) stackerSqueeze);
	
	grabberExtension = new CANTalon(16);
	...
	grabberExtension->ConfigNeutralMode(CANSpeedController::NeutralMode::kNeutralMode_Brake);
