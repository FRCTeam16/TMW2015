...
void RobotMap::init() {
	...
	stackerLiftFrontRight = new CANTalon(12, 2);
...
//	stackerLiftFrontRight->SetCloseLoopRampRate(2);
	stackerLiftFrontLeft->SetControlMode(CANSpeedController::kFollower);
